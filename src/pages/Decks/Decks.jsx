          ...
          <ul className="deck__list">
            {sortFlashcardsByTime(flashcards).map((deck) => (
              <Link to={deck.id} key={deck.id}>
                <li className="deck-card card--blue">
                  <h2 className="deck-card__title">{deck.metadata.title.toUpperCase()}</h2>
                  <div className="deck-card__metadata-container">
                    ...
                    <div className="deck-card__metadata-right">
                      <p className="deck-card__metadata">{`${deck.metadata.cardCount} flashcards`} </p>
                    </div>
                  </div>
                </li>
              </Link>
