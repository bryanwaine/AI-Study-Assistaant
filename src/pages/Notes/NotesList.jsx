  ...
  return (
    <ul className="notes__list">
            {sortFlashcardsByTime(notes).map((note) => (
              <li key={note.id}>
                <Link to={note.id} className="session-card bg-gray-900/10 dark:bg-gray-100/10 rounded-xl">
                  ...
                  <div className="note-card__metadata-container">
                    <p className="note-card__metadata text-neutral-900 dark:text-neutral-100">
                      <span className="note-card__metadata-item text-sky-900 dark:text-sky-400">File</span>
                      {note.metadata.fileName || ""}
                    </p>
                    <p className="note-card__metadata text-neutral-900 dark:text-neutral-100">
                      <span className="note-card__metadata-item text-sky-900 dark:text-sky-400">Created</span>
