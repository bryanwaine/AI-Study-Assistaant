...
const Sidebar = ({ sidebarOpen, handleLogout, userName, email }) => {
  return (
    <div className="sidebar bg-gray-100/90 dark:bg-neutral-900/90  backdrop-blur-md" data-sidebar-open={sidebarOpen}>
      <h3 className="text-md align-left self-start !ml-4 text-sky-900 dark:text-sky-400 font-light">ACCOUNT</h3>
      ...
      <h3 className="text-md align-left self-start !ml-4 text-sky-900 dark:text-sky-400 font-light">APP</h3>
      <ul className="sidebar__list">
        <li className="bg-sky-100 dark:bg-black">
