...
const DashboardOverviewSkeleton = () => {
  return (
    <div className="dashboard-card__overview">
      <div className="skeleton__card dashboard-card__item rounded-xl bg-neutral-100 dark:bg-gray-100/10 backdrop-blur shadow-md border border-neutral-200 dark:border-none">
